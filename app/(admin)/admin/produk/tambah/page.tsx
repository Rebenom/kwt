...
export default function AddProductPage() {
  ...
  const [unit, setUnit] = useState('bungkus');
  const [certification, setCertification] = useState('P-IRT No. 2068804011911-26');
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-2xl md:text-3xl font-extrabold text-gray-950 tracking-tight">Tambah Produk Baru</h1>
      </div>
